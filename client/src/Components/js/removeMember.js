...
const RemoveUserFromGroup = () => {
    ...
    const allTheUsersInGroup = useSelector((state)=>state.groupStoreCreation.allTheUsersInGroup);

    const selectTheUsersFromGroup = useSelector((state)=>state.groupStoreCreation.selectTheUsersFromGroup);
